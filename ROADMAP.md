...
## v1.0 — Foundation ✅
- [x] 29 MAX Bot API endpoints
- [x] 26 data models
- [x] 20 guides in 8 categories
- [x] MAX Bridge API (objects + events)
- [x] 35 MAX UI components
- [x] 7 MCP tools (list, get, search)
- [x] Resource URIs (`max-docs://`)
- [x] Multi-client quickstart (Claude, Cursor, OpenCode, Codex)
...
Have an idea? [Open an issue](https://github.com/Launchery/max_docs_mcp/issues) or start a [discussion](https://github.com/Launchery/max_docs_mcp/discussions).
